...
/**
 * Request validation for updating financer modules.
 *
 * @property array{modules: array<array{id: string, active: bool, promoted?: bool, price_per_beneficiary?: int}>} $validated
 */
class UpdateFinancerModulesRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
             ...
             * @example 5000
             */
            'core_package_price' => ['required', 'nullable', 'integer', 'min:0', 'max:9999999'],
    ...
    public function messages(): array
    {
        return [
            ...
            'modules.*.promoted.boolean' => 'Promoted must be true or false',
