...
class StripePaymentSucceeded implements ShouldBroadcast
{
    use Dispatchable;
    ...
    public function __construct(
        ...
        Log::warning('[WebSocket]  StripePaymentSucceeded', $this->payment->toArray());
    }
    ...
    {
        return 'stripe.payment.succeeded';
    }
}
