...
class BulkToggleModulesAction
{
    ...
    /**
     * Execute the action to bulk toggle modules for a division
     *
     ...
     * @throws Exception
     */
    public function execute(array $moduleIds, Division $division): array
    {
        // Validate input
        ...
        try {
            ...
            $results = $this->moduleService->bulkToggleForDivision($moduleIds, $division);
            ...
            if (! app()->environment('testing')) {
                ...
                activity()
                    ...
                    ->log('Bulk module toggle for division');
            }

            if (! app()->environment('testing')) {
                Log::info('Bulk module toggle for division', [
            ...
            if (! app()->environment('testing')) {
                Log::error('Bulk module toggle failed', [
                    'division_id' => $division->id,
                    'module_ids' => $moduleIds,
                    'error' => $e->getMessage(),
                    'user_id' => auth()->id(),
