...
use App\Projectors\DivisionBalanceProjector;
use App\Projectors\InvoiceGenerationProjector;
...
return [
     ...
     */
    'projectors' => [
        CreditBalanceProjector::class,
        DivisionBalanceProjector::class,
        InvoiceGenerationProjector::class,
    ],
